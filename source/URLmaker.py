### Friday, November 6, 2020, 9:13 AM, Biden just took over Trump in PA, and will probably be declared the winner today
...
def main():
    ...
    #print (glam_string)
    #glam_string = glam_string + "Review[Filter] AND (" not needed here as we look for all papers
    ...
    final_URL_string = "open https://pubmed.ncbi.nlm.nih.gov/?term=" + URL_string + "%28" + myQuery + "%29+\&sort=pubdate\&size=50"
